...
`,[x(">",[c("clear",`
 ...
 `,[ln({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),ue=E({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(e){return sn("-base-clear",jn,Be(e,"clsPrefix")),{handleMouseDown(o){o.preventDefault()}}},render(){const{clsPrefix:e}=this;return t("div",{class:`${e}-base-clear`},t(un,null,{default:()=>{var o,a;return this.show?t(ce,{clsPrefix:e,key:"dismiss",class:`${e}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},{default:()=>t(Kn,null)}):t("div",{key:"icon",class:`${e}-base-clear__placeholder`},(a=(o=this.$slots).default)===null||a===void 0?void 0:a.call(o))}}))}}),Yn=E({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(e,{slots:o}){return()=>{const{clsPrefix:a}=e;return t(cn,{clsPrefix:a,class:`${a}-base-suffix`,strokeWidth:24,scale:.85,show:e.loading},{default:()=>e.showArrow?t(ue,{clsPrefix:a,show:e.showClear,onClear:e.onClear},{default:()=>t(ce,{clsPrefix:a,class:`${a}-base-suffix__arrow`},{default:()=>Q(o.default,()=>[t(Un,null)])})}):null})}}});const Fe=dn("n-input");function Xn(e){let o=0;for(const a of e)o++;return o}function J(e){return["",void 0,null].includes(e)}var ye=E({name:"InputWordCount",setup(e,{slots:o}){const{mergedValueRef:a,maxlengthRef:d,mergedClsPrefixRef:s}=Ce(Fe),l=A(()=>{const{value:u}=a;return u===null||Array.isArray(u)?0:Xn(u)});return()=>{const{value:u}=d,{value:f}=a;return t("span",{class:`${s.value}-input-word-count`},fn(o.default,{value:f===null||Array.isArray(f)?"":f},()=>[u===void 0?l.value:`${l.value} / ${u}`]))}}}),Zn=g("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
