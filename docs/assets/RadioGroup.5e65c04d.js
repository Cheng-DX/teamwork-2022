import{B as j,m as ne,C as O,r as I,p as ae,F as E,ay as H,U as ie,P as F,v as _,z as u,q as R,x as g,A as P,d as G,D as V,bO as N,c as $,V as D,aj as M,I as K,i as y,az as de,H as se,am as le}from"./index.a58e7b45.js";import{u as L}from"./Input.a1fe08f7.js";import{g as ue}from"./get-slot.ef4c002f.js";const ce={name:String,value:{type:[String,Number],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,validator:()=>(ie("radio","`checked-value` is deprecated, please use `checked` instead."),!0),default:void 0}},q=ne("n-radio-group");function A(e){const o=O(e,{mergedSize(n){const{size:s}=e;if(s!==void 0)return s;if(r){const{mergedSizeRef:{value:b}}=r;if(b!==void 0)return b}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(e.disabled||r!=null&&r.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:t,mergedDisabledRef:i}=o,a=I(null),v=I(null),r=ae(q,null),c=I(e.defaultChecked),d=E(e,"checked"),p=L(d,c),m=H(()=>r?r.valueRef.value===e.value:p.value),C=H(()=>{const{name:n}=e;if(n!==void 0)return n;if(r)return r.nameRef.value}),f=I(!1);function w(){if(r){const{doUpdateValue:n}=r,{value:s}=e;F(n,s)}else{const{onUpdateChecked:n,"onUpdate:checked":s}=e,{nTriggerFormInput:b,nTriggerFormChange:l}=o;n&&F(n,!0),s&&F(s,!0),b(),l(),c.value=!0}}function x(){i.value||m.value||w()}function z(){x()}function k(){f.value=!1}function S(){f.value=!0}return{mergedClsPrefix:r?r.mergedClsPrefixRef:j(e).mergedClsPrefixRef,inputRef:a,labelRef:v,mergedName:C,mergedDisabled:i,uncontrolledChecked:c,renderSafeChecked:m,focus:f,mergedSize:t,handleRadioInputChange:z,handleRadioInputBlur:k,handleRadioInputFocus:S}}A.props=ce;var be=_("radio",`
