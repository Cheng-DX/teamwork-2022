import{p as j,Y as ne,b4 as O,r as I,$ as ae,a9 as U,Z as H,b7 as ie,aW as $,l as _,aC as u,k as R,n as g,aH as P,d as G,q as F,bM as M,e as V,v as D,a_ as N,x as K,j as y,aL as de,a3 as se,ba as le}from"./index.332a15a2.js";import{u as L}from"./Input.64dc662d.js";import{g as ue}from"./get-slot.ef4c002f.js";const ce={name:String,value:{type:[String,Number],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,validator:()=>(ie("radio","`checked-value` is deprecated, please use `checked` instead."),!0),default:void 0}},W=ne("n-radio-group");function A(e){const o=O(e,{mergedSize(n){const{size:s}=e;if(s!==void 0)return s;if(r){const{mergedSizeRef:{value:b}}=r;if(b!==void 0)return b}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(e.disabled||r!=null&&r.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:t,mergedDisabledRef:i}=o,a=I(null),v=I(null),r=ae(W,null),c=I(e.defaultChecked),d=U(e,"checked"),p=L(d,c),m=H(()=>r?r.valueRef.value===e.value:p.value),C=H(()=>{const{name:n}=e;if(n!==void 0)return n;if(r)return r.nameRef.value}),f=I(!1);function w(){if(r){const{doUpdateValue:n}=r,{value:s}=e;$(n,s)}else{const{onUpdateChecked:n,"onUpdate:checked":s}=e,{nTriggerFormInput:b,nTriggerFormChange:l}=o;n&&$(n,!0),s&&$(s,!0),b(),l(),c.value=!0}}function x(){i.value||m.value||w()}function k(){x()}function z(){f.value=!1}function S(){f.value=!0}return{mergedClsPrefix:r?r.mergedClsPrefixRef:j(e).mergedClsPrefixRef,inputRef:a,labelRef:v,mergedName:C,mergedDisabled:i,uncontrolledChecked:c,renderSafeChecked:m,focus:f,mergedSize:t,handleRadioInputChange:k,handleRadioInputBlur:z,handleRadioInputFocus:S}}A.props=ce;var be=_("radio",`
